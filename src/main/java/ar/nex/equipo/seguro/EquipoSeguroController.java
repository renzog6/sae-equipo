 ...
 * @author Renzo
 */
public class EquipoSeguroController implements Initializable {

    public EquipoSeguroController() {
    }

    public Parent getRoot() {
        Parent root = null;
        try {
            root = FXMLLoader.load(getClass().getResource("/fxml/seguro/EquipoSeguro.fxml"));
            root.setStyle("/css/equipo.css");
        } catch (IOException ex) {
            Logger.getLogger(EquipoSeguroController.class.getName()).log(Level.SEVERE, null, ex);
        }
        return root;
    }
